...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://cases-app-two.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing everything for delivery you will received your
              package very soon depending where you're located.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If your have any questions regarding your order please feel free
